 ...
 */
package org.messic.android.messiccore.controllers.messicdiscovering;
        ...
        try {
            ...
            while (interfaces.hasMoreElements()) {
                ...
                for (InterfaceAddress interfaceAddress : networkInterface.getInterfaceAddresses()) {
                    ...
                    Timber.d("Request packet sent to: " + broadcast.getHostAddress()
            ...
            while (!this.cancel) {
                ...
                try {
                    ...
                    // We have a response
                    Timber.d("Broadcast response from server: "
                    ...
                    if (message.toLowerCase(Locale.US).contains("messic")) {
                        try {
                            ...
                            Timber.e("messic-discovering", e.getMessage(), e);
                        }
                    }
            ...
            Timber.e("messic-discovering", ex.getMessage(), ex);
        }
